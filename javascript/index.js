...
function comedyChallenge() {
    ...
    challenge.generateDescription();
    if (randomNumber(0, 100) >= 50 && currentCast.length == 10 && !isPairChallenge && regularFormat){
...
function designChallenge() {
    ...
    challenge.generateDescription();
    if (randomNumber(0, 100) >= 50 && currentCast.length == 10 && !isPairChallenge && regularFormat && currentCast != firstCast && currentCast != secondCast && !uk3Premiere && !s9Premiere && !conjoinedQueens && episodeCount > 1){
        isPairChallenge = true;
        pairMaking();
        challenge.rankPerformances();
    } else {
...
function CheckForSpecialEvents(slay, great, good, bad, flop) {
    if (slay.length === 0 && great.length === 0 && currentCast.length >= 8 && !floppersCheck && randomNumber(0, 100) >= 99 && !conjoinedCheck)
        floppers = true;
